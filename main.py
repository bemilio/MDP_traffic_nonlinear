...
if __name__ == '__main__':
    ...
    for test in range(N_random_tests):
        ...
        while  not is_problem_feasible:
            ...
            game = Game(T_horiz, N_agents, Road_graph, initial_state, final_destinations, add_terminal_cost=False, add_destination_constraint=True, epsilon_probability=0.05, xi=4)
            if test == 0:
